...
# for k in range(0,4):
femm.ei_modifyconductorprop('v0',1,1);
...
# # # Draw a rectangle for the coil;
# femm.ei_drawrectangle(0, -10, 10, 10);

# # Define an "open" boundary condition using the built-in function:
# femm.ei_makeABC()

# femm.ei_addblocklabel(5,0);
# # femm.ei_addblocklabel(30,100);


# # Add some block labels materials properties
# femm.ei_addmaterial('Air', 1, 1, 1);
# femm.ei_addmaterial('Iron', 2100, 2100, 1);


# femm.ei_selectlabel(30,100);
# femm.ei_setblockprop('Air', 0, 1, '<None>');
# femm.ei_clearselected()


# femm.mi_selectlabel(5,0);
# femm.mi_setblockprop('Iron',1,0,1);
# femm.mi_clearselected()
...
# # femm.ei_setblockprop('Air',0,1,1,0,0,0);
# femm.ei_clearselected()

# femm.ei_zoomnatural()


# femm.ei_saveas('gun.res')
